...
*Vista general del panel de control con estadísticas en tiempo real*

### 🤖 Análisis de IA
![AI Detection](./assets/img/Deteccion_AI.png)
*Interfaz de detección y análisis de contenido generado por IA*

### 🌌 Exploración NASA
![NASA APOD](./assets/img/Nasa_Apod.png)
*Galería de imágenes astronómicas del día de la NASA*
