...
export class SidebarComponent {
  menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      label: '📋 Historial IA',
      route: '/ai-detection/history',
      description: 'Consultas anteriores de IA',
    },
    {
    ...
    {
      icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
      label: '📋 Historial NASA',
      route: '/nasa-apod/history',
      description: 'Imágenes consultadas anteriores',
    },
  ];
  ...
  getIconBgClass(index: number): string {
    const colors = [
      ...
      'bg-gradient-to-br from-card-cyan to-card-cyan-dark',
      'bg-gradient-to-br from-card-orange to-card-orange-dark',
      'bg-gradient-to-br from-card-purple to-card-purple-dark',
    ];
